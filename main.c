...
static  int max(int  x , int y) /*we use static before declaring the variable allows to keep the value and the continuous just for this function and is not to be visible for the rest of the program*/
{
